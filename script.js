...
function updateNavButtons() {
    // Update both header and footer navigation buttons
    ['header', 'footer'].forEach(location => {
        document.getElementById(`first-btn-${location}`).disabled = currentIndex === 0;
        document.getElementById(`prev-btn-${location}`).disabled = currentIndex === 0;
        document.getElementById(`next-btn-${location}`).disabled = currentIndex === comics.length - 1;
        document.getElementById(`latest-btn-${location}`).disabled = currentIndex === comics.length - 1;
    });
}
...
['header', 'footer'].forEach(location => {
    // First button
    document.getElementById(`first-btn-${location}`).addEventListener('click', () => {
        displayComic(0);
    });

    // Previous button
    document.getElementById(`prev-btn-${location}`).addEventListener('click', () => {
        if (currentIndex > 0) {
    ...
    // Archive button
    document.getElementById(`archive-btn-${location}`).addEventListener('click', () => {
    ...
    // Next button
    document.getElementById(`next-btn-${location}`).addEventListener('click', () => {
    ...
    // Latest button
    document.getElementById(`latest-btn-${location}`).addEventListener('click', () => {
